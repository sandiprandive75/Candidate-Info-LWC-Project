...
export default class NewCandidateForm extends LightningElement {
    ...
    @wire(getObjectInfo, { objectApiName: CANDIDATE_INFO_OBJECT })
    candidateObjInfo;

    @track countryOptions;
    @track stateOptions;

    @wire(getPicklistValues, { recordTypeId: '$candidateObjInfo.data.defaultRecordTypeId', fieldApiName: COUNTRY })
    ...
    handleCountryChange(event) {
        ...
        this.stateOptions = this.slaFieldData.values.filter(opt => opt.validFor.includes(key));
    }
